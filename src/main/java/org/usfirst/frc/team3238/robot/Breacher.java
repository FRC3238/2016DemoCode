...
public class Breacher {
    ...
    Breacher(WPI_TalonSRX breacherTalon) {
    ...
    Breacher(WPI_TalonSRX breacherTalon, DigitalInput armDetectTop,
    ...
    void run(Joystick assistantDriver) {
        ...
        if(assistantDriver.getRawButton(4) && armDetectTop.get()) moveArm(1.0);
        else if(assistantDriver.getRawButton(6)) moveArm(-.7);
        else moveArm(0.0);
    }
